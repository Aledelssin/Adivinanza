// buscamos un numero aleatorio entre 1 y 50
        ...
        if(contadorRespuestas<numeroRespuestas)
        {
            ...
            if(isNumber(numero) && numero>0 && numero<100)
            {
                ...
                if(numero>numeroAdivinar)
                {
                    ...
                    respuestas+="<br>"+numero+" - El número que buscas es inferior";
                    document.getElementById("numero").focus();
                }else if(numero<numeroAdivinar){
                    // El numero es inferior

                    // Añadimos un texto a las respuestas
                    respuestas+="<br>"+numero+" - El número que buscas es superior";
                    document.getElementById("numero").focus();
                }else{
                    // has acertado
            ...
            respuestas+="<br><span class='fin'>NO HAS ACETADO!! El número era el "+numeroAdivinar+"</span>";
